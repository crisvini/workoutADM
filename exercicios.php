                ...
                <div class="col-12">
                    <div class="bg-black w-100 br-10 p-2">
                        <div class="row mx-1 my-2">
                            ...
                            <div class="col-2">
                                <div class="form-floating">
                                    <input type="number" class="form-control fw-normal fs-5 bg-gray border-black color-white" placeholder="Séries" id="series">
                        ...
                        <div class="row mx-1 mt-4 mb-2">
                            ...
                            <div class="col-3">
                                <div class="form-floating">
                                    <select class="form-control fw-normal fs-5 bg-gray border-black color-white" placeholder="Treino" id="treino">
